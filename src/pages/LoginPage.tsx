...
import { fetchKeywordSubscriptions } from '../api/keywords'
import { persistKeywordSubscriptions } from '../utils/keywordSubscriptions'
...
export default function LoginPage() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      try {
        const keywords = await fetchKeywordSubscriptions()
        persistKeywordSubscriptions(keywords)
      } catch {
        // best effort only
      }
